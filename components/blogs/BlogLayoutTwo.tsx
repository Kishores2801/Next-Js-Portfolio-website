  ...
  return (
    <>
      {post && post.mainImage && post.slug && (
        <div className="grid grid-cols-1 md:grid-cols-9 gap-6 items-center text-dark overflow-hidden">
          {/* Blog Image */}
          <Link
          ...
          >
            ...
            <div className="col-span-1 md:col-span-6 flex flex-col md:justify-center space-y-4 text-left md:text-right  md:mt-0">
            {/* Tag Component */}
            ...
            <h1 className="text-lg sm:text-lg md:text-xl font-bold capitalize">
              ...
              >
                <span className="bg-gradient-to-r from-blue-300 to-blue-500 bg-[length:0px_3px] hover:bg-[length:100%_6px] bg-left-bottom bg-no-repeat transition-[background-size] duration-500">
                  {post.title}
                </span>
              </Link>
            </h1>
